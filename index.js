...
client.on('interactionCreate', async interaction => {
  ...
  if (commandName === '개집벽') {
    ...
    setTimeout(function(){const message = interaction.channel.send({ files: ["https://i.imgur.com/hoXsMBF.gif"] });},4000)
    message.react('❤️');
    ...
    setTimeout(function(){const message = interaction.channel.send({ files: ["https://i.imgur.com/3DuhauC.gif"] });},4000);
    message.react('❤️');
   ...
   setTimeout(function(){interaction.channel.send('||불||')},4000);
    await interaction.channel.send('```이라는 키워드를 얻으셨습니다.```')
    wait(2000)
    setTimeout(function(){const message = interaction.channel.send({ files: ["https://i.imgur.com/ukXkrfF.gif"] });},4000);
    message.react('❤️');
   ...
   setTimeout(function(){interaction.channel.send('\n\n```당신의 진짜 이름은 sincere 입니다. onlooker 방관자에서 벗어나셨기 때문에 진짜 이름을 찾으셨습니다.``` \n\n')},10000);
    ...
    await interaction.channel.send('```이라는 키워드를 얻으셨습니다.```')
    wait(2000)
   setTimeout(function(){const message = interaction.channel.send({ files: ["https://i.imgur.com/lAqxsGO.gif"] });},4000);
    message.react('❤️');
    ...
    await interaction.channel.send('```이라는 키워드를 얻으셨습니다.```')
    wait(2000)
    setTimeout(function(){const message = interaction.channel.send({ files: ["https://i.imgur.com/wVWUCwO.gif"] });},4000);
    message.react('❤️');
